...
class PeliculaDetalle  extends StatelessWidget {
  ...
  Widget _crearAppbar(Pelicula pelicula){
    return SliverAppBar(
        ...
        expandedHeight: 200.0,//que tan expandido se quiere 
        floating: false,
        pinned: true,//que se encuentre visible cuando se empiece a hacer el scroll
        ...
        ) ,//es el widget que se adapta en la caja del silver appbar
          ...
          Hero(
            ...
            child: ClipRRect(
              borderRadius: BorderRadius.circular(20.0),
                child: Image(
                image:(pelicula.getPosterImg() != null) ? NetworkImage(pelicula.getPosterImg()) : AssetImage('assets/img/no-image.jpg'),
                height: 150.0,
              ),
            ),
          ),
